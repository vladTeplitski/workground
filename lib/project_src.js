...
function createChartWeek(dataset){
      ...
      graphWeek2.borderColor = "#386fa7";
      graphWeek2.borderWidth = "3";
      graphWeek2.pointRadius= "5";
      graphWeek2.pointHoverRadius= "6";
      graphWeek2.pointHoverBackgroundColor = "#386fa7";
      graphWeek2.pointHoverBorderColor = "#386fa7";
      graphWeek2.backgroundColor = 'rgba(224,239,255, 0.2)';
...
function createChartMonth(dataset){
  ...
  //document.getElementById("debug46").innerHTML = "Into createChartMonth()";
    ...
    graphMonthLine.borderColor = "#386fa7";
    graphMonthLine.borderWidth = "3";
    graphMonthLine.pointRadius= "0";
    graphMonthLine.pointHoverRadius= "6";
    graphMonthLine.pointHoverBackgroundColor = "#386fa7";
    graphMonthLine.pointHoverBorderColor = "#386fa7";
    graphMonthLine.backgroundColor = 'rgba(224,239,255, 0.2)';
...
function createChart3Month(dataset){
  ...
  //document.getElementById("debug49").innerHTML = "Into createChart3Month()";
    ...
    graph3MonthLine.borderColor = "#386fa7";
    graph3MonthLine.borderWidth = "3";
    graph3MonthLine.pointRadius= "0";
    graph3MonthLine.pointHoverRadius= "6";
    graph3MonthLine.pointHoverBackgroundColor = "#386fa7";
    graph3MonthLine.pointHoverBorderColor = "#386fa7";
    graph3MonthLine.backgroundColor = 'rgba(224,239,255, 0.2)';
...
function createChart6Month(dataset){
  ...
  //document.getElementById("debug52").innerHTML = "Into createChart3Month()";
    ...
    graph6MonthLine.borderColor = "#386fa7";
    graph6MonthLine.borderWidth = "3";
    graph6MonthLine.pointRadius= "0";
    graph6MonthLine.pointHoverRadius= "4";
    graph6MonthLine.pointHoverBackgroundColor = "#386fa7";
    graph6MonthLine.pointHoverBorderColor = "#386fa7";
    graph6MonthLine.backgroundColor = 'rgba(224,239,255, 0.2)';
...
function createChartYear(dataset){
  ...
  //document.getElementById("debug55").innerHTML = "Into createChartYear()";
    ...
    graphYearLine.borderColor = "#386fa7";
    graphYearLine.borderWidth = "3";
    graphYearLine.pointRadius= "0";
    graphYearLine.pointHoverRadius= "4";
    graphYearLine.pointHoverBackgroundColor = "#386fa7";
    graphYearLine.pointHoverBorderColor = "#386fa7";
...
function createChart3Year(dataset){
    ...
    graph3YearLine.borderColor = "#386fa7";
    graph3YearLine.borderWidth = "3";
    graph3YearLine.pointRadius= "0";
    graph3YearLine.pointHoverRadius= "3";
    graph3YearLine.pointHoverBackgroundColor = "#386fa7";
    graph3YearLine.pointHoverBorderColor = "#386fa7";
    graph3YearLine.scaleOverride= true;
    graph3YearLine.backgroundColor = 'rgba(224,239,255, 0.2)';
...
function createChart5Year(dataset){
  ...
  graph5YearLine.borderColor = "#386fa7";
  graph5YearLine.borderWidth = "3";
  graph5YearLine.pointRadius= "0";
  graph5YearLine.pointHoverRadius= "1.5";
  graph5YearLine.pointHoverBackgroundColor = "#386fa7";
  graph5YearLine.pointHoverBorderColor = "#386fa7";
  graph5YearLine.scaleOverride= true;
  graph5YearLine.backgroundColor = 'rgba(224,239,255, 0.2)';
...
function createChartDaily(dataset){
      ...
      callbacks: {
        ...
        label: function(tooltipItems, data) { 
          var multistringText = ["Lock Rate: $" + fixCommas(tooltipItems.yLabel)];
              ...
              //multistringText.push('Turnover: $' + fixCommas(turnover_data[tooltipItems.index]));
              //Print vals in info box
              //document.getElementById("dailyDate").innerHTML = 'Date: ' + x_data[tooltipItems.index];
              //document.getElementById("dailyLockRate").innerHTML = 'Lock Rate: $' + fixCommas(tooltipItems.yLabel);
              //document.getElementById("dailyPrevClose").innerHTML = 'Previous Close: $' + fixCommas(prevClose_data[tooltipItems.index]);
              //document.getElementById("dailyOpeningRate").innerHTML = 'Opening Rate: $' + fixCommas(openingRate_data[tooltipItems.index]);
              ...
              //document.getElementById("dailyTurnover").innerHTML = 'Turnover: $' + fixCommas(turnover_data[tooltipItems.index]);
  ...
  graphDailyLine.label = "Daily";
  graphDailyLine.fill = true;
  graphDailyLine.borderColor = "#386fa7";
  graphDailyLine.borderWidth = "3";
  graphDailyLine.pointRadius= "0";
  graphDailyLine.pointHoverRadius= "1.5";
  graphDailyLine.pointHoverBackgroundColor = "#386fa7";
  graphDailyLine.pointHoverBorderColor = "#386fa7";
  graphDailyLine.scaleOverride= true;
  graphDailyLine.backgroundColor = 'rgba(224,239,255, 0.2)';
